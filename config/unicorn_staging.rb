...
approot = '/var/www/fraefel_staging/app/current/'
appuser = 'fraefel_staging'
...
before_fork do |server, worker|
  ...
  old_pid = "#{approot}/tmp/pids/unicorn.pid.oldbin"
...
after_fork do |server, worker|
  ...
  #This shit fucks up the whole unicorn process plxx fix ivo developers :P
  # 
