Fraefel::Application.configure do
  ...
  #config.assets.precompile += %w(pdf_css_application.css)
  #config.assets.precompile += %w(report_css_application.css)
  #config.assets.precompile += %w(pdf_js_application.js)
